          ...
          if( MForceCal(SamplePositionIdx, i+1 ) ){
              ...
              DataNoIdx_Old = DataNoIdx ;
               ...
               if( KDC1Data[SamplePositionIdx-1].KEIJYO_KBN == 5 ){
                  if( i == 0)
                       pEdt1[SamplePositionIdx-1]->Text = FormatFloat("#0.00",KDC1Data[SamplePositionIdx-1].SOKUTEI_M[i] );
                  else if( i == 1)
                       pEdt2[SamplePositionIdx-1]->Text = FormatFloat("#0.00",KDC1Data[SamplePositionIdx-1].SOKUTEI_M[i] );
                  else
                       pEdt3[SamplePositionIdx-1]->Text = FormatFloat("#0.00",KDC1Data[SamplePositionIdx-1].SOKUTEI_M[i] );
               } else {
                  if( i == 0)
