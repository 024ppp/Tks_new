...
void __fastcall TForm1::AddHIST()
{
	 ...
	 sBuf += " SEQNO,KENSA_KMK,KOUMOKU_J,KOUMOKU_E,KEIJKBN,TANI, KOJOKBN";       //20160701_工場区分追加
     sBuf += " )";
     ...
     //検索結果 ０件
        ...
        sBuf += "ZISNAM, LOTNO, SEQNO, KOJOKBN, SOKUTEI_NO, SOKUTEI_CH";
        sBuf += " )";
        sBuf += " values('";
        sBuf += Tmp_KDB1.KENSA_YMD				+ "','";
        sBuf += Tmp_KDB1.DTKSHIN				+ "','";
