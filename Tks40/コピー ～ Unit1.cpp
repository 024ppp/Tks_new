...
void __fastcall TForm1::FormCreate(TObject *Sender)
{
     ...
     SGr1->ColWidths[9] = Panel18->Width;   //形状区分名
...
void __fastcall TForm1::BtnF07Click(TObject *Sender)
{
     ...
     while( !Query1->Eof ){
        ...
        {
			case 1: //直方体
                SGr1->Cells[9][iRow] = "直方体";
                break;
            case 2: //円柱
                SGr1->Cells[9][iRow] = "円柱";
                break;
			//case 1: //小型ブロック
            //    SGr1->Cells[3][iRow] = "小型";
            //    break;
            //case 2: //中型
            //    SGr1->Cells[3][iRow] = "中型";
            //    break;
            //case 3: //大型
            //    SGr1->Cells[3][iRow] = "大型";
            //    break;
            //case 4: //円柱
            //    SGr1->Cells[3][iRow] = "円柱";
            //    break;
            default:
                SGr1->Cells[9][iRow] = " ";
                break;
     ...
     //sBuf = Form1->Query1->FieldValues["ZISCOD"];
     //EdtZIS->Caption = sBuf;               //材質コード
     //
     //sBuf = Form1->Query1->FieldValues["LOTNO"];
     //EdtLOT->Text = sBuf;               //ロットNO
...
void __fastcall TForm1::BtnF08Click(TObject *Sender)
{
    ...
    Tmp_KDB1.SEQNO  = SEQNOMAX + 1;
     ...
     if( AddData() == False ){
        ...
        {
			case 1: //直方体
                SGr1->Cells[9][SGr1->RowCount - 1] = "直方体";
                break;
            case 2: //円柱
                SGr1->Cells[9][SGr1->RowCount - 1] = "円柱";
                break;
            //case 1: //小型ブロック
...
void __fastcall TForm1::BtnF09Click(TObject *Sender)
{
    ...
    if ( Tmp_KDB1.KENSA_KMK == 5 ) {
     ...
     DataSave = true;
        ...
        {
			case 1: //直方体
                SGr1->Cells[9][SGr1->Row] = "直方体";
                break;
            case 2: //円柱
                SGr1->Cells[9][SGr1->Row] = "円柱";
                break;
            //case 1: //小型ブロック
            //    SGr1->Cells[3][SGr1->Row] = "小型";
            //    break;
            //case 2: //中型
            //    SGr1->Cells[3][SGr1->Row] = "中型";
            //    break;
            //case 3: //大型
            //    SGr1->Cells[3][SGr1->Row] = "大型";
            //    break;
            //case 4: //円柱
            //    SGr1->Cells[3][SGr1->Row] = "円柱";
            //    break;
            default:
		...
		sBuf = FloatToStr(Tmp_KDB1.JYOKEN1);
		SGr1->Cells[27][SGr1->Row] = sBuf;               //更新回数
