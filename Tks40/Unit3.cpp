...
void __fastcall TForm3::Button11Click(TObject *Sender)
{
 ...
 sprintf(str_c, " where KENSA_YMD ='%s' and SEQNO =%d and DTKSHIN = '%s' and LOTNO = '%s'",
...
//                   Cur_Kdb1.DTKSHIN, Cur_Kdb1.LOTNO);
    sprintf(str_c, "delete kdb2 where KENSA_YMD = '%s' and SEQNO = %d and DTKSHIN = '%s' and LOTNO = '%s'",
                   Cur_Kdb1.KENSA_YMD.c_str(), Cur_Kdb1.SEQNO, Cur_Kdb1.DTKSHIN, Cur_Kdb1.LOTNO);
    str = str_c;
...
*/
      // Insert
       ...
       sprintf(str_c, "%s%s%s", "insert into KDB2 (KENSA_YMD, SEQNO, DTKSHIN, LOTNO, HINBAN, ZISCOD, ZISNAM, SOKUTEI_NO,",
                      ...
                      " SOKUTEI_MEI5, SOKUTEI_MEI6, SOKUTEI_MEI7)");
       str = str_c ;
       str_c[0] = NULL;

       sprintf(str_c, " values('%s', %d, '%s', '%s', '%s', '%s', '%s', %d, %.3f, %.3f, %.3f, %.3f, %.3f, %.3f, %.3f, %.3f)",
