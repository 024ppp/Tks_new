...
// File Mapping関係変数
HANDLE MapFileHandle[MAXSHARE] = {NULL, NULL, NULL, NULL, NULL};
HANDLE hMem1[MAXSHARE] = {NULL, NULL, NULL, NULL, NULL};
LPVOID pShrMem1[MAXSHARE] = {NULL, NULL, NULL, NULL, NULL};
TRec_IFarea Comm_Buff[MAXSHARE];			// 通信エリア
TRec_DataBuff DataBuffer;					// データエリア
int OpenFlag[MAXSHARE] = {0, 0, 0, 0, 0};	// 0: 未Open;  1: Opened
int BuffType[MAXSHARE] = {0, 0, 0, 0, 0};	// 0: Server(Create);  1: Client(Open)
HWND Owner[MAXSHARE];
int SM_DataFlag[MAXSHARE] = {0, 0, 0, 0, 0}; // <= 0: No Data; > 0: Data Size
