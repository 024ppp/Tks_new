...
__published:	// IDE 管理のコンポーネント
    ...
    TBevel *Bevel33;
        ...
        void __fastcall ScrollBarAChange(TObject *Sender);
        void __fastcall edttlnoEnter(TObject *Sender);
        void __fastcall BtnF02Enter(TObject *Sender);
        void __fastcall EdtV4Change(TObject *Sender);
        void __fastcall edtymdKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift);
        void __fastcall EdtA1Exit(TObject *Sender);
