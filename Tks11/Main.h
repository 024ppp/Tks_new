...
extern struct structKD11{
      ...
      double BURASI_MIN ;      //ブラシ幅 規格下
      double BURASI_MAX ;      //ブラシ幅 規格上
...
//ブラシ幅寸法計測履歴ﾃﾞｰﾀﾌｧｲﾙ変数 KD13W
extern struct structKD13W{
      AnsiString DTKSHIN;         //得意先品番
      AnsiString LOTNO[50];        //ロットNO
      double BURASI_MIN[50] ;      //ブラシ幅 規格下
      double BURASI_MAX[50] ;      //ブラシ幅 規格上
...
extern void AddKd13W(void);
extern int  CheckLotNo(int ) ;
extern void CurseBack(void );
extern void CopyKD11Data(void) ;

extern int IsNullSpace(AnsiString);
extern int Kd11_Serch01(void);
extern int Kd11_Serch02(void);
extern void Kd11_Update01(void);

extern long  Kd13W_Create01(AnsiString, int, int) ;
extern int  Kd13W_Serch01();
