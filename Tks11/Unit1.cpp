...
//---------------------------------------------------------------------------
// KD11構造体変数
structKD11 KD11Data[30];      //ブラシ幅寸法ﾃﾞｰﾀﾌｧｲﾙ  KD11

//KD13W構造体変数
structKD13W KD13WData[30];    //ブラシ幅寸法計測履歴ﾃﾞｰﾀﾜｰｸﾌｧｲﾙ  KD13W


//---------------------------------------------------------------------------
//画面操作用変数
int iRec_Kd11;              //一覧検索結果件数
...
void __fastcall TForm1::ScrollBar1Change(TObject *Sender)
{
   ...
   //マウスでScrollBarをＣｈａｎｇｅする以外の場合
   if( iSaveFlag ) return ;

   //マウスでScrollBarをＣｈａｎｇｅする場合
