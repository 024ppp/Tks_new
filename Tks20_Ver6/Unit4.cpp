...
//---------------------------------------------------------------------------
void __fastcall TForm4::QRDBText6Print(TObject *sender, AnsiString &Value)
{
    if ( Value == "1" ) Value = "合格";
    else Value = "不合格";
...
//---------------------------------------------------------------------------
void __fastcall TForm4::QRLabel35Print(TObject *sender, AnsiString &Value)
{
    if ( PageFlag == 1 )
    {
        Value = "*";
...
//---------------------------------------------------------------------------
//得意先品番
void __fastcall TForm4::QRDBText3Print(TObject *sender, AnsiString &Value)
{
...
//開始ロットNo
void __fastcall TForm4::QRDBText1Print(TObject *sender, AnsiString &Value)
{
...
//終了ロットNo
void __fastcall TForm4::QRDBText2Print(TObject *sender, AnsiString &Value)
{
...
void __fastcall TForm4::QRLabel39Print(TObject *sender, AnsiString &Value)
{
    static int p = 0;
...
void __fastcall TForm4::QRLabel41Print(TObject *sender, AnsiString &Value)
{
...
void __fastcall TForm4::QRLabel42Print(TObject *sender, AnsiString &Value)
{
