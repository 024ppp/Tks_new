...
void __fastcall TForm5::QRDBText6Print(TObject *sender, AnsiString &Value)
{
    if ( Value == "1" ) Value = "合格";
    else Value = "不合格";
...
void __fastcall TForm5::QRLabel35Print(TObject *sender, AnsiString &Value)
{
    if ( PageFlag == 1 )
    {
        Value = "*";
...
void __fastcall TForm5::QRDBText3Print(TObject *sender, AnsiString &Value)
{
    AnsiString str;
    AnsiString Daystr;
    str = Value;
...
void __fastcall TForm5::QRLabel39Print(TObject *sender, AnsiString &Value)
{
    static int p = 0;
...
void __fastcall TForm5::QRLabel41Print(TObject *sender, AnsiString &Value)
{
...
void __fastcall TForm5::QRLabel42Print(TObject *sender, AnsiString &Value)
{
...
void __fastcall TForm5::QRBand1BeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
...
//---------------------------------------------------------------------------
//得意先名
void __fastcall TForm5::QRLabel44Print(TObject *sender, AnsiString &Value)
{
    Value = "   ";
}
//---------------------------------------------------------------------------

void __fastcall TForm5::QRDBText1Print(TObject *sender, AnsiString &Value)
{
    sBufDTKSCOD = Value;
}
//---------------------------------------------------------------------------
void __fastcall TForm5::QRDBText2Print(TObject *sender, AnsiString &Value)
{
    AnsiString SQLstr;
